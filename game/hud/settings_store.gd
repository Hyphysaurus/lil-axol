...
var arrive_from := ""                # the scene we crossed FROM (Batch B): lets a legacy reach find
                                     # its own door pointing back and arrive you there, not at the
                                     # hardcoded west mouth ("" = direct boot / unknown -> west mouth)
